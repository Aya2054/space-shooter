...
public class BigEnemy extends Enemy {
    ...
    public BigEnemy(float movementSpeed, int health, float xPosition, float yPosition, float width,
        ...
        super(movementSpeed, health, xPosition, yPosition, width, height, enemyTexture, projectileWidth,
                projectileHeight, projectileMovementSpeed, rateOfFire, projectileTexture, "Big");
    }
